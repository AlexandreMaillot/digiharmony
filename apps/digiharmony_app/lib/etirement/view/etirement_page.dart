...
import 'package:digiharmony_app/etirement/etirement_l10n.dart';
        ...
        children: [
          ...
          if (enPause) ...[
            ...
            Text(
              ...
              style: const TextStyle(color: ThemeApplication.accent),
            ),
          ],
          const Spacer(),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: switch (v.status) {
                      EtirementStatutSegment.fait => ThemeApplication.primary,
                      EtirementStatutSegment.actif => ThemeApplication.success,
                      EtirementStatutSegment.aVenir => ThemeApplication.muted
                ...
                Expanded(
                  child: ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      ...
                      minHeight: 4,
                      backgroundColor:
                          ThemeApplication.surface.withValues(alpha: 0.5),
