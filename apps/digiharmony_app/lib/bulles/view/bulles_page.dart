...
import 'package:digiharmony_app/bulles/routes_bulles.dart';
...
class BullesView extends StatelessWidget {
  ...
  Future<void> _onBulleTap(BuildContext context, IdCategorieBulle id) async {
    ...
    await Navigator.of(context).push(RoutesBulles.pourCategorie(id));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: ThemeApplication.hubBackground,
      appBar: BarreOutils(
      ...
      body: FondApplication(
        background: ThemeApplication.hubBackground,
        child: SafeArea(
          child: Column(
            children: [
              Padding(
