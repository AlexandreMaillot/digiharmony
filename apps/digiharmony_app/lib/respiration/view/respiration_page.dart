...
import 'package:digiharmony_app/respiration/respiration_l10n.dart';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: RadialGradient(
          colors: [
            ThemeApplication.primary.withValues(alpha: 0.5),
            ThemeApplication.primary.withValues(alpha: 0.1),
          ],
        ),
        border: Border.all(
          color: ThemeApplication.primary.withValues(alpha: 0.6),
        ),
      ),
      child: Icon(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: i <= current
                    ...
                    : ThemeApplication.muted.withValues(alpha: 0.3),
              ),
            ),
          ),
      ],
