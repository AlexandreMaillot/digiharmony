...
import 'package:digiharmony_app/detox/format_duree_detox.dart';
import 'package:digiharmony_app/detox/widgets/fleur_detox_animee.dart';
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: ThemeApplication.detoxSea.withValues(alpha: 0.1),
        ...
        child: Row(
          ...
          children: [
            Icon(
              ...
              size: 16,
              color: ThemeApplication.detoxSea,
            ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          const Icon(Icons.flight, size: 18, color: ThemeApplication.muted),
