...
import 'package:digiharmony_app/sens/bloc/sens_bloc.dart';
import 'package:digiharmony_app/sens/donnees/depot_audio_sens.dart';
import 'package:digiharmony_app/sens/domaine/usecase/usecase.dart';
import 'package:digiharmony_app/sens/sens_l10n.dart';
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: ThemeApplication.primary.withValues(alpha: 0.1),
              border: Border.all(
                color: ThemeApplication.primary.withValues(alpha: 0.27),
              ),
            ),
            child: Icon(
              step.sense.icon,
          ...
          Text(
            ...
            style: const TextStyle(
              color: ThemeApplication.sensesAccent,
              fontSize: 72,
              ...
              Expanded(
                ...
                child: FilledButton.icon(
                  style: FilledButton.styleFrom(
                    backgroundColor: ThemeApplication.sensesAccent,
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: i < current
                      ? ThemeApplication.primary.withValues(alpha: 0.55)
                      : i == current
                      ? ThemeApplication.sensesAccent
                      : ThemeApplication.muted.withValues(alpha: 0.2),
                ),
              ),
            ),
        ],
...
class _CarteInstruction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: ThemeApplication.surface.withValues(alpha: 0.5),
        ...
        for (final s in doneSteps)
          Chip(
            avatar: const Icon(
              Icons.check,
              size: 16,
              color: ThemeApplication.success,
            ),
            label: Text(l10n.sensesRecapDone(s.count, s.sense.label(l10n))),
            backgroundColor: ThemeApplication.surface.withValues(alpha: 0.4),
          ),
      ],
    );
  }
