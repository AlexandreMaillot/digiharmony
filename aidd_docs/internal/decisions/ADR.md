...
| 2026-06-10 | DEC-008 | [Navigation par bottom bar (5 onglets)](./0008-navigation-bottom-bar.md) | `MainShell` + `IndexedStack` paresseux ; sections sans retour ; écrans de tâche poussés avec bouton Fermer (X) ; sans GoRouter |
| 2026-06-12 | DEC-009 | [Langue système, repli anglais](./0009-langue-systeme-repli-anglais.md) | `localeListResolutionCallback` : suit la langue du téléphone si supportée, sinon `en` (corrige le repli alphabétique vers `el`) |
| 2026-06-12 | DEC-010 | [Alarmes exactes pour le rappel](./0010-alarmes-exactes-rappel.md) | `SCHEDULE_EXACT_ALARM` + « Alarmes et rappels » → notif à l'heure pile ; repli inexact si refusée ; permission fonctionnelle, zéro collecte |
